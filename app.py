...
if page == "Dataset":
    ...
    selected_universitas = st.selectbox('Pilih Universitas', data['universitas'].unique())
    filtered_data = data[data['universitas'] == selected_universitas]
    ...
    plt.xlabel('Semester')
    plt.title(f"Visualisasi Data untuk {selected_universitas}")
